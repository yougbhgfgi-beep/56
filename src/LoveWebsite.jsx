...
export default function LoveWebsite() {
    ...
    const loveStartDate = new Date("2025-09-23T00:00:00");
                ...
                <div className="grid md:grid-cols-3 gap-10 max-w-6xl mx-auto">
                    {[1, 2, 3].map((num) => (
                        <motion.div
                            ...
                            className="p-2 bg-gradient-to-r from-pink-400 to-rose-500 rounded-3xl shadow-2xl"
                        >
                            <div className="bg-white h-72 rounded-2xl flex items-center justify-center text-xl">
                                صورة {num}
                            </div>
                        </motion.div>
                    ))}
